...
# Для разработки: указываем, где находятся статические файлы
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'booking.authentication.ApiKeyAuthentication',
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Satva Wellness Booking API',
    'DESCRIPTION': 'REST API v1 для системы бронирования Satva Wellness',
    'VERSION': '1.0.0',
